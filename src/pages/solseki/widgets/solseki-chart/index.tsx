...
export const solsekiChart: WidgetConfig = {
  definition: { defaultRowSpan: 4, defaultColumnSpan: 2, minRowSpan: 3 },
  data: {
    title: 'Solana Price',
    description: 'Solana price over time',
    header: SolsekiChartHeader,
    content: SolsekiChartContent,
    footer: SolsekiChartFooter,
    staticMinHeight: 560,
  },
};
